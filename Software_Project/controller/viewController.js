const planModel=require("../model/newComplaintModel");
...
//Make a RegisterComplaint form function
async function getComplaintPage(req,res){
    // let plans=await planModel.find().limit(3);
    // let plans=(await planModel.find()).slice(0,3);
    let name=req.userName;
    res.render("complaint.pug",{
        title:"Complaint Page" //,  plans,name
    })
}
...
async function getComplaintStatus(req,res){
    ...
    // let plans=(await planModel.find()).slice(0,3);
    let name=req.userName;
    res.render("complaintStatusFile.pug",{
        title:"Complaint Status Page" //,  plans,name
    })
}
...
module.exports.getComplaintStatus=getComplaintStatus;
module.exports.getComplaintPage=getComplaintPage;
